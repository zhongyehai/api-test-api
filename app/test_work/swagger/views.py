...
from app.api_test.module.models import Module
...
def get_parsed_module(module_list, project_id, module_name):
    ...
    module = Module().create(
        {'project_id': project_id, 'name': module_name, 'num': Module.get_insert_num(project_id=project_id)})
    module_list[module.name] = module
    return module
...
def swagger_pull():
    ...
    project, module_list = Project.get_first(id=request.json.get('id')), {}
